# Phase 4: 登録店舗サジェスト機能 実装指示

## やること
1. `components/ClinicSuggest.tsx` を新規作成
2. `app/[locale]/ai-diagnosis/page.tsx` を編集

---

## Step 1: components/ClinicSuggest.tsx を新規作成
...
## Step 2: app/[locale]/ai-diagnosis/page.tsx を編集

### 2-1. import追加
ファイル冒頭のimport群の末尾に追加：
```tsx
import ClinicSuggest from '@/components/ClinicSuggest';
```

### 2-2. ClinicSuggestを結果画面に挿入
結果画面の免責事項（amber のボックス）の直前に挿入：
...
- 爪／かかと両方の診断結果画面にヒューマン鍼灸接骨院のカードが表示されること
